...
from diffclipRL.mattergen.common.data.custom_types import PropertySourceId, TargetProperty
from diffclipRL.mattergen.common.utils.data_utils import get_atomic_number
from diffclipRL.mattergen.common.utils.globals import MAX_ATOMIC_NUM, PROPERTY_SOURCE_IDS
...
class EmbeddingVector(BaseUnconditionalEmbeddingModule):
    ...
    def __init__(self, hidden_dim: int):
        super().__init__()
        # a vector of learnable param of shape (hidden_dim,)
