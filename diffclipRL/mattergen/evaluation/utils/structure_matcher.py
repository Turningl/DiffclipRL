...
from diffclipRL.mattergen.evaluation.utils.globals import MAX_RMSD
...
class DefaultOrderedStructureMatcher(OrderedStructureMatcher):
    """
    Ordered structure matcher with default param. No args or kwargs are passed in order
...
class DefaultDisorderedStructureMatcher(DisorderedStructureMatcher):
    """
    Disordered structure matcher with default param. No args or kwargs are passed in order
    to ensure consistent behavior across all instances.
    """
