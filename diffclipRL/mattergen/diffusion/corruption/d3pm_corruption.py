...
from diffclipRL.mattergen.diffusion.corruption.corruption import B, Corruption, maybe_expand
from diffclipRL.mattergen.diffusion.d3pm import d3pm
from diffclipRL.mattergen.diffusion.data.batched_data import BatchedData
from diffclipRL.mattergen.diffusion.discrete_time import to_discrete_time
...
class D3PMCorruption(Corruption):
    ...
    def prior_sampling(
        ...
        if conditioning_data['atomic_numbers'] is not None:
            return conditioning_data['atomic_numbers']
        else:
