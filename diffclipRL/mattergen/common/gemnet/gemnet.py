...
from diffclipRL.mattergen.common.gemnet.layers.atom_update_block import OutputBlock
from diffclipRL.mattergen.common.gemnet.layers.base_layers import Dense
from diffclipRL.mattergen.common.gemnet.layers.efficient import EfficientInteractionDownProjection
from diffclipRL.mattergen.common.gemnet.layers.embedding_block import EdgeEmbedding
from diffclipRL.mattergen.common.gemnet.layers.interaction_block import InteractionBlockTripletsOnly
from diffclipRL.mattergen.common.gemnet.layers.radial_basis import RadialBasis
from diffclipRL.mattergen.common.gemnet.layers.scaling import AutomaticFit
from diffclipRL.mattergen.common.gemnet.layers.spherical_basis import CircularBasisLayer
from diffclipRL.mattergen.common.gemnet.utils import (
    inner_product_normalized,
    mask_neighbors,
    ragged_range,
    repeat_blocks,
)
from diffclipRL.mattergen.common.utils.data_utils import (
    frac_to_cart_coords_with_lattice,
    get_pbc_distances,
    lattice_params_to_matrix_torch,
    radius_graph_pbc,
)
# from diffclipRL.mattergen.common.utils.globals import MODELS_PROJECT_ROOT, get_device, get_pyg_device
from diffclipRL.mattergen.common.utils.lattice_score import edge_score_to_lattice_score_frac_symmetric
...
class GemNetT(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        scale_file = '/home/zl/DiffclipRL/diffclipRL/mattergen/common/gemnet/gemnet-dT.json'
    ...
    def forward(
        ...
        #####################latent vectors##########################
        if self.task == 'clip':
            batch_atoms = torch.arange(num_atoms.size(0),
                                 device=num_atoms.device).repeat_interleave(num_atoms, dim=0)

            latent_vectors = scatter(h, batch_atoms, dim=0, reduce="mean")  # (nMolecules, emb_size_atom)
